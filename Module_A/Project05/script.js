...
// Function to fetch a random iser and assign random wealth
...
function updateDOM(userData = userArray) {
    ...
    userData.forEach( user => {
        ...
        // Display the new divElement in th DOM
        main.appendChild(divElement);
    });
};

// Format wealth number as dollor
...
function doubleWealth() {
    ...
    // Update the DOM after the wealth is doubled
    updateDOM();
};
...
// 2. Listen for click on Double Wealth Button
doubleWealthBtn.addEventListener('click', doubleWealth);

// 3. Listen for click on Show Millionaire Button
filterWealthBtn.addEventListener('click', filterWealth);

// 4. Listen for click on Sort Users Button
sortWealthBtn.addEventListener('click', sortUser);

// 4. Listen for click on the Calculate Net Wealth Button
